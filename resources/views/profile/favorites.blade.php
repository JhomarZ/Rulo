                  ...
                  <div class=" ">
                    <div class="row">
                        ...
                        @foreach($favorites as $fav)
                          <div class="col-md-3 col-md-4 col-xs-6 content ">
                            <div class="card mb-4 ">
                                @if($fav->product->files->count()>0)
                                    <img style="max-height: 90px" class="card-img-top" src="{{$fav->product->files[0]->image_list}}" data-holder-rendered="true">
                                @else
                              ...
                              <div class="card-body">
                                  ...
                                  <p class="text-detail float-left  mt-1 "><b> S/ {{$fav->product->price_list}} - {{$fav->product->price_sale}}</b></p>
